        ...
        return(
            <div className="container-fluid">
                ...
                <div className="row">
                    <div className="col-md-3 col-sm-3 col-lg-3"></div>
                    <div className="col-md-6 col-sm-6 col-lg-6">
                    <button type="submit" className="btn w-100 " id="button_1"><a className="texto_1" href="/">Inicia sesión</a></button>
                    </div>
                    <div className="col-md-3 col-sm-3 col-lg-3"></div>
                </div>
                </form>
                ...
                <div className="row">
                    ...
                    <div className="col">
                    <p id="text_2"><a className="texto_1" href="/">Continuar sin una cuenta</a></p>
                    </div>
                    <div className="col-md-3 col-sm-3 col-lg-3"></div>
                </div>
            </div>
