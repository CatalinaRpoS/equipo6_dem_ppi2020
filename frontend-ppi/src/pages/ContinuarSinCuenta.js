...
class ContinuarSinCuenta extends React.Component{
  render(){
    return(
      <div>
        <NavbarVacio/>
        <ImagenTitulo imagen={Imagen1} texto="¿NO QUIERES CREAR UNA CUENTA?" texto2="¡Entonces échale un vistazo a los siguientes tips de ahorro de energía!"/>
        <Cards1 Data={Data}/>
        <Footer1 btn1="Regístrate" btn2="¡Entendido!"/>
      </div>
    );
  }
